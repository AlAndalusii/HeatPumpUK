...
export default function AreHeatPumpsWorthItPage() {
  ...
  return (
    <>
      <Head>
        <title>Are Heat Pumps Worth It? The Honest Answer for UK Homes</title>
        <meta name="description" content="The truth about whether heat pumps are worth it for UK homes. Get honest costs, savings analysis, and find out if a heat pump is right for your home." />
        <meta name="keywords" content="are heat pumps worth it, heat pump worth the cost, heat pump cost benefit, heat pump savings UK, heat pump vs boiler comparison" />
      </Head>
      ...
      <section className="pt-32 pb-12 px-6 bg-linear-to-br from-[#ff9500] to-[#ff6b6b]">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-[40px] md:text-[56px] lg:text-[64px] font-semibold text-white mb-6 tracking-tight leading-[1.1]">
            Are Heat Pumps Worth It? The Honest Answer
          </h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg mb-12">
            <p className="text-[19px] md:text-[21px] text-[#1d1d1f] leading-[1.6] mb-6">
              Let me get straight to the point. You're thinking about getting a heat pump, and you want to know if it's actually worth the money and hassle. Fair question.
            </p>
            <p className="text-[19px] md:text-[21px] text-[#1d1d1f] leading-[1.6] mb-6">
              I'm going to give you the honest answer, not the sales pitch. Because here's the thing about heat pumps in the UK right now: they can be absolutely brilliant for some homes and a complete nightmare for others. The trick is figuring out which camp you're in.
            </p>
          </div>

          {/* What Actually Is a Heat Pump Anyway? */}
          <div className="mb-16">
            ...
            <div className="bg-[#f5f5f7] rounded-2xl p-8 mb-8">
              <p className="text-[17px] text-[#1d1d1f] leading-[1.6] mb-4">
                Before we talk about whether they're worth it, let me explain what a heat pump actually does. Because most people think it's some complicated space-age technology, but it's really not.
              </p>
              <p className="text-[17px] text-[#1d1d1f] leading-[1.6]">
                A heat pump is basically a fridge that works backwards. Your fridge takes heat from inside and dumps it outside, keeping your food cold. A heat pump takes heat from outside and brings it inside, keeping your house warm.
              </p>
            </div>
            ...
            <p className="text-[17px] text-[#1d1d1f] leading-[1.6]">
              There's also <strong>ground source heat pumps</strong> that get heat from underground, but they cost way more and you need to dig up your garden. Most people go for air source because it's simpler and cheaper.
            </p>
          </div>

          {/* So How Much Does a Heat Pump Actually Cost? */}
          <div className="mb-16">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1d1d1f] mb-6 tracking-tight">
              So How Much Does a Heat Pump Actually Cost?
            </h2>
            ...
            <p className="text-[17px] text-[#1d1d1f] leading-[1.6] mb-6">
              So if your heat pump costs twelve thousand pounds and you get the seven and a half grand grant, you're actually paying <strong>four and a half thousand</strong>. Still not pocket change, but way better than twelve grand.
            </p>
          ...
          <div className="mb-16">
            ...
            <p className="text-[17px] text-[#1d1d1f] leading-[1.6] mb-8">
              Here's where we need to be really honest. Whether a heat pump saves you money depends on a few things.
            </p>
            ...
            <p className="text-[17px] text-[#1d1d1f] leading-[1.6]">
              The real savings come from that seven and a half grand grant. If you were going to replace your boiler anyway and it was going to cost you five or six grand for a new gas boiler, then paying four and a half grand for a heat pump instead makes sense. You're getting future-proof technology for basically the same money.
            </p>
          </div>
          ...
          {/* The Honest Truth About Heat Pumps vs Gas Boilers */}
          <div className="mb-16">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1d1d1f] mb-6 tracking-tight">
              The Honest Truth About Heat Pumps vs Gas Boilers
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Link href="/blog/how-heat-pumps-work">
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                <img src="/modern-heat-pump-installation.jpg" alt="How heat pumps work" className="w-full h-48 object-cover" />
                <div className="p-6">
                  <h3 className="text-[20px] font-semibold text-[#1d1d1f] mb-2">How Do Heat Pumps Work? The Simple Guide</h3>
